...
func init() {
	...
	_ = RegisterStdBuiltinModuleWithPrefix("phone", "phone_", "phone_parse", "phone_valid", "phone_country", "phone_networks")
	_ = RegisterStdBuiltinModuleWithPrefix("ip", "ip_", "ip_is_private", "ip_client_from_header", "ip_geo_init", "ip_country", "ip_lookup")
