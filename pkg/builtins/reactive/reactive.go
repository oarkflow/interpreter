...
func (c *Computed) compute() object.Object {
	...
	case *object.Function:
		...
		if c.env != nil && c.env.RuntimeLimits != nil {
			extEnv.RuntimeLimits = c.env.RuntimeLimits.CloneForConcurrentExecution()
		}
	...
	case *object.Function:
		if object.ExtendFunctionEnvFn != nil && object.EvalFn != nil {
			...
			if env != nil && env.RuntimeLimits != nil {
				extEnv.RuntimeLimits = env.RuntimeLimits.CloneForConcurrentExecution()
			}
