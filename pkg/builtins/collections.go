...
func sumArrayValues(arr *object.Array) (object.Object, object.Object) {
	...
	if allInt {
		return object.IntegerObj(int64(totalFloat)), nil
	}
	return &object.Float{Value: totalFloat}, nil
}

func sumBuiltinOne(arg object.Object) object.Object {
	if arg.Type() != object.ARRAY_OBJ {
		return &object.String{Value: fmt.Sprintf("argument to `sum` must be ARRAY, got %s", arg.Type())}
	}
	sumObj, errObj := sumArrayValues(arg.(*object.Array))
	if errObj != nil {
		return errObj
	}
	return sumObj
